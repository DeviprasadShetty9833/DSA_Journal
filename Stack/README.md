...
> Q. Why do we restrict access to only one end?
> - To guarantee O(1) time complexity for add/remove and to enforce a specific order of operations. If you allow random access, it's just a List, and you lose the semantic guarantee of "most recent first."
